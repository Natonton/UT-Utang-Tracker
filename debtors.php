                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row text-center mx-1">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <form action="adminProcess.php?debtorID=<?php echo $debtorID?>" method="POST">
                                        ...
                                        <div class="input-group mb-3">
                                          <span class="input-group-text"></span>
                                          <input type="tel" aria-label="Number" class="form-control" value="<?php echo $debtorNumber; ?>" name="number">
                                        </div>
                                        <div class="input-group mb-3">
                                          <span class="input-group-text"></span>
                            ...
                            <a data-bs-toggle="modal" data-bs-target="#viewHistory<?php echo $debtorID;?>" class="p-2 mb-1" style="color: black; background-color: skyblue; border-radius: 3px; cursor:pointer;"><i class="fa-solid fa-clock-rotate-left fs-5"></i></a>
                            <!-- view history Modal -->
