            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form action = "adminProcess.php?adminID=<?php echo $adminID;?>" method = "POST" enctype="multipart/form-data">
                    <div class="row mb-3">
                      <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Profile Image</label>
                      <div class="col-md-8 col-lg-9">
                        <img src="assets/img/<?php echo $adminPic;?>" alt="Profile">
                        <div class="pt-2">
                          <label for="fileInput" class="btn btn-primary btn-sm w-1">
                            <input type="file" accept=".jpg, .jpeg, .jfif, .gif, .webp" id="fileInput" name="pp"></input>
                          </label>
                          <label for="reset" class="btn btn-danger btn-sm">
